    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        switch (apiMethod) {
            ...
            case "CameraInfo":
                ...
                break;
            case "CameraPhoto":
                TermuxApiLogger.info("CameraPhoto started.");
            ...
            case "VideoStream":
                TermuxApiLogger.info("VideoStream Started");
                if (TermuxApiPermissionActivity.checkAndRequestPermissions(context, intent, Manifest.permission.CAMERA)) {

                    intent.setComponent(new ComponentName(context, VideoService.class));
